      ...
      (function (t) {
        ...
        function (t, e, n) {
          var r = n(53),
            ...
            f = 2083,
            l = [],
            h = i.url(o.CLIENT_EVENT_ENDPOINT, {
              dnt: 0,
              l: '',
            }),
          ...
          function m(t, e, n, r, i) {
            ...
            if (!u && !f)
              return (
                ...
                (e = e || {}),
                c.resolve(
                  v(o.formatClientEventNamespace(t), o.formatClientEventData(e, n, r), s.settingsScribe(), i),
                )
              );
          }
          function v(t, e, n, s) {
            ...
            (o.prototype.read = function (t, e) {
              ...
              (o.prototype.write = function (t, e) {
                ...
                return (
                  ...
                  'writing' === r || 'reading' === r || this.batch.scheduled ? i : (this.scheduleBatch(), i)
                );
              }),
            ...
            flush: function () {
              return E.promise.then(function () {
                ...
                return r.children.length <= 2
                  ? f.reject()
                  : ((t = f.all([o.doc.body.appendChild(r), o.doc.body.appendChild(i)]).then(function (t) {
                      var e = t[0],
                        n = t[1];
                      return (
              ...
              (t = {
                ...
                (n = function (t) {
                  ...
                  if (
                    ...
                    try {
                      (n = 'string' == typeof t.data ? c.parse(t.data) : t.data).namespace === l.settings &&
                        ((b = g.aug(b, {
        ...
        function (t, e, n) {
          ...
          t.exports = function t(e) {
            ...
            if (e)
              return (
                (n = e.lang || e.getAttribute('data-lang')), r.isType('string', n) ? n : t(e.parentElement)
              );
          };
        },
        function (t, e, n) {
        ...
        function (t, e, n) {
          ...
          function l(t, e, n) {
            ...
            t &&
              t.postMessage &&
              (f ? (r = (n || '') + o.stringify(e)) : n ? ((r = {})[n] = e) : (r = e), t.postMessage(r, '*'));
          }
          function h(t) {
          ...
          u.aug(m.prototype, {
            ...
            u.aug(v.prototype, {
              ...
              send: function (t) {
                var e = new s();
                return (
                  t.id ? (this.pending[t.id] = e) : e.resolve(), l(this.target, t, this.filter), e.promise
                );
              },
            }),
            (t.exports = {
            ...
            return a(t, f).map(function (t) {
              return u(
                (function (t) {
                  ...
                  return (
                    a.isPreconfigured && (c.isSearchUrl(a.url) ? d.publicError(l, t) : d.publicLog(h, t)),
                ...
                get: function () {
                  ...
                  return (
                    this.params.id
                      ...
                      : ((t = a(this.params)), e.push('screen-name', t.screen_name, 'slug', t.list_slug)),
                    o.embedService(e)
                  );
                },
              }),
            ...
            t.params({
              ...
              t.overrideProperty('endpoint', {
                get: function () {
                  ...
                  return (
                    e ? t.push('screen-name', e) : t.push('user-id', this.params.userId), s.embedService(t)
                  );
                },
              }),
